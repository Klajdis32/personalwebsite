...
const posts = [
    ...
    },
    {
        ...
        Date: "15/02/2025",
        Katigoria: "Cybersecurity", 
        Keimeno: "This project is an assignment given to me during the Google.org Cybersecurity Seminars and concerns user permissions on Linux machines. As part of this project, I present the solutions to the questions of this assignment, which was given to us after lessons on managing user permissions, files, and directories in Linux.",
        Link: "",
        htmlPdf: "/htmls/LinuxPermissions.html",
        pdf: "",
        file: "",
        video: ""
    },
    ...
    },
    {
        ...
        imageEksw: "", 
        imageMesa: "", 
        Titlos: "Encryption-Cryptanalysis with the Cryptool Tool", 
        Sigrafeas: "Me", 
        Linksigrafea: "",  
        Date: "27/01/2025",
        Katigoria: "Cybersecurity", 
        Keimeno: "This project represents my effort within the framework of the assigned activity-task in the Google.org Cybersecurity Seminars (1st Cycle, Activity 1: Introduction to Cryptography). Below, you will find my answers to the activity’s questions. Additionally, at the top of the page, there is a link to the Cryptool tool, while at the bottom of the page, all the .txt files used are included.",
        Link: "",
