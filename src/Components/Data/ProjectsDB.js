...
const posts = [
    ...
    },
    {
        ...
        Date: "14/07/2024",
        Katigoria: "Programming", 
        Keimeno: "Η Be a Beast είναι μια νέα  ιστοσελίδα γυμναστικής, η οποία έχει δημιουργηθεί χρησιμοποιώντας την τεχνολογία React. Στόχος της είναι να παρέχει προγράμματα γυμναστικής μέσω του διαδικτύου. Η σελίδα διαθέτει έναν διαδραστικό προσομοιωτή, ο οποίος επιτρέπει στους χρήστες να επιλέγουν τη μυϊκή ομάδα που επιθυμούν μέσω SVG γραφικών και να λαμβάνουν προτεινόμενες ασκήσεις για την επιλεγμένη ομάδα. Επιπλέον, παρέχεται η δυνατότητα να ζητηθούν εξατομικευμένα προγράμματα γυμναστικής από άτομα με προσωπική εμπειρία στον τομέα της γυμναστικής. Η σελίδα Be a Beast έχει σχεδιαστεί για να βοηθήσει τους χρήστες να ανακαλύψουν τη δύναμη του σώματός τους και να επιτύχουν τους στόχους της φυσικής τους κατάστασης, μέσω μιας εύχρηστης και καινοτόμας ιστοσελίδας.",
