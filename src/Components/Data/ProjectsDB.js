...
const posts = [
    {
        ...
        imageEksw: "", 
        imageMesa: "", 
        Titlos: "Χρήστες και δικαιώματα σε Linux μηχανήματα", 
        Sigrafeas: "Me", 
        Linksigrafea: "",  
        Date: "15/02/2025",
        Katigoria: "Cybersecurity", 
        Keimeno: "Το συγκεκριμένο project αποτελεί μια εργασία που μου ανατέθηκε στα Σεμινάρια Κυβερνοασφάλειας της Google.org και αφορά τα δικαιώματα χρηστών σε μηχανές Linux. Στο πλαίσιο αυτού του project, παραθέτω τις λύσεις στα ερωτήματα της εργασίας αυτής, η οποία μας δόθηκε μετά από μαθήματα σχετικά με τη διαχείριση δικαιωμάτων χρηστών, αρχείων και φακέλων στο Linux.",
        Link: "",
