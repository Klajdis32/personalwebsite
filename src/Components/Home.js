...
const Home = () => {
    ...
    <div className="container">
        ...
        <div className="divkeimeno" id="en"> 
            ...
            <br /><br />
            <div className='ligopiodeksia'>Incidentally from now &#40;04/05/2024&#41; and on, this website has been recreated with react js <img src={imgreact} alt="reactimg" className="toreact"  /> . You can find the new code on my github repository &#40; <a href='https://github.com/Klajdis32/personalwebsite' target='_blanck' className="toatoykeimenoy" >personal website</a> &#41;.</div>
