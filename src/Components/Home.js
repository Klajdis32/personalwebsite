...
const Home = () => {
    ...
    <div class="container">
        <div class="divlogo">
            <img src={Logo} alt="" class="tologoA" /><br />
        ...
        <div class="divkeimeno" id="en"> 
            ...
            <br /><br />Furthermore with the help of my brother 🫂 &#40; <a href="https://tsami.gr/" class="toatoykeimenoy">Kristi Cami</a> &#41;, who is studying computer science 👨‍💻 at the same university, and through online resources like Github and videos from YouTube, I have learned the basics of computer languages such as C, Python, Php and JavaScript, and I am also proficient in HTML and CSS. This knowledge has been instrumental in helping me create this webpage.
        ...
        <div class="divkeimeno" id="gr"> 
            ...
            <p>Διαθέτω ένα ακόρεστο πάθος για μάθηση και είμαι πάντα πρόθυμος να αποκτήσω νέες γνώσεις. Παράλληλα με τις θεμελιώδεις έννοιες που διδάσκονται στο σχολείο, έχω επιδιώξει ενεργά τα ενδιαφέροντά μου στην αστρονομία 🚀 και τον προγραμματισμό υπολογιστών 💻. 
                ...
                <br /><br />Επιπλέον, με τη βοήθεια του αδερφού μου 🫂 &#40; <a href="https://tsami.gr/" class="toatoykeimenoy">Kristi Cami</a> &#41;, που σπουδάζει πληροφορική 👨‍💻 στο ίδιο πανεπιστήμιο, και μέσω διαδικτυακών πόρων όπως το Github και μέσω του YouTube, έμαθα τα βασικά των γλωσσών προγραμματισμού όπως C, Python, Php και JavaScript. Γνωρίζω ακόμη Html και Css, αυτή η γνώση με βοήθησε πολύ στο να δημιουργήσω τη συγκεκριμένη ιστοσελίδα. 
        ...
        <div class="divkeimeno" id="ge"> 
            ...
            <br /><br />Außerdem mit Hilfe meiner Bruder 🫂 &#40; <a href="https://tsami.gr/" class="toatoykeimenoy">Kristi Cami</a> &#41;, der an derselben Universität Informatik studiert 👨‍💻, und über Online-Ressourcen wie Github und Videos von YouTube, Ich habe die Grundlagen von Computersprachen wie C, Python, Php und JavaScript erlernt und beherrsche außerdem HTML und CSS. Dieses Wissen wurde Er hat mir maßgeblich bei der Erstellung dieser Webseite geholfen.
